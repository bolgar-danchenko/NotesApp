...
class MainViewController: UIViewController {
    ...
    let label = UILabel()           // Appears if there are no notes yet
    let button = AddButton()        // Button at the bottom right corner
    ...
    @objc private func didTapButton() {
        ...
        noteVC.set(noteCell: (tableView?.cellForRow(at: IndexPath(row: 0, section: 0)) as! NoteTableViewCell))
